...
import 'controller/help_center_controller.dart';import 'package:final_grad_proj/core/app_export.dart';import 'package:final_grad_proj/widgets/custom_icon_button.dart';import 'package:final_grad_proj/widgets/custom_text_form_field.dart';import 'package:flutter/material.dart';class HelpCenterScreen extends GetWidget<HelpCenterController> {
                       ...
                       child: Column(mainAxisSize: MainAxisSize.min,
                           ...
                           children: [
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                         ...
                                         Padding(padding: EdgeInsets.only(
                                             ...
                                             child: Text("lbl_help_center2".tr,
                            ...
                            CustomTextFormField(width: 335.w,
                                ...
                                fontStyle: TextFormFieldFontStyle.RubikLight18,
                            ...
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                ...
                                children: [
                                 Text("msg_booking_a_new_a".tr,
                                     ...
                                     textAlign: TextAlign.left,
                                     style: AppStyle.txtRubikLight18),
                                 Padding(padding: EdgeInsets.only(top: 4.h, bottom: 4.w),
                                     child: CommonImageView(
                            ...
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                ...
                                children: [
                                 Text("msg_online_consulta".tr,
                                     ...
                                     textAlign: TextAlign.left,
                                     style: AppStyle.txtRubikLight18),
                                 Padding(padding: EdgeInsets.only(top: 4.h, bottom: 4.h),
                                     child: CommonImageView(
                                         svgPath: ImageConstant.imgArrowright,
                                         height: 12.00.h,
                                         width: 7.0.w))
                            ...
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                ...
                                children: [
                                 Text("lbl_other_issues".tr,
                                     ...
                                     textAlign: TextAlign.left,
                                     style: AppStyle.txtRubikLight18),
                                 Padding(padding: getPadding(top: 4, bottom: 4),
                                     child: CommonImageView(
                                         svgPath: ImageConstant.imgArrowright,
                                         height: 12.00.h,
                                         width: 7.00.w))
