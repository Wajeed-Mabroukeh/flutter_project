              ...
              children: [
               Align(alignment: Alignment.centerLeft,
                   child: Container(width: size.width,
                       ...
                       child: Padding(padding: EdgeInsets.only(left: 24.w, right: 16.w),
                           child: Row(mainAxisAlignment: MainAxisAlignment
                               ...
                               children: [Row(
                                   ...
                                   ]), Padding(padding: EdgeInsets.only(top: 5.h, bottom: 3.h),
               ...
               Align(alignment: Alignment.centerLeft,
                   child: Padding(
                       padding: EdgeInsets.only(left: 56.w, top: 4.h, right: 56.w),
               ...
               Align(alignment: Alignment.centerLeft,
                   child: Padding(
                       padding: EdgeInsets.only(left: 56.w, top: 8.h, right: 56.w),
                       child: Text("msg_aug_12_2020_at".tr,
                           overflow: TextOverflow.ellipsis,
                           textAlign: TextAlign.left,
                           style: AppStyle.txtOverpassRegular13))),
