                       ...
                       child: Column(mainAxisSize: MainAxisSize.min,
                           ...
                           children: [
                            ...
                            Align(
                                ...
                                child: Text("msg_account_setting".tr,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle
                                        .txtRubikMedium18Bluegray500))),
                            Padding(padding: EdgeInsets.only(left: 19.w,top: 9.h,right: 19.w),
                                             ...
                                             Row(
                                               ...
                                               children: [
                                                 CustomIconButton(
                                                   height: 32.h,
                                                   width: 32.w,
                                                   variant: IconButtonVariant.FillGreen700,
                                                   shape: IconButtonShape.CircleBorder16,
                                                   child: CommonImageView(
                                                     color: Colors.white,
                                             ...
                                             Row(
                                               ...
                                               children: [
                                                 CustomIconButton(
                                                   height: 32.h,
                                                   width: 32.w,
                                                   variant: IconButtonVariant.FillLightblue301,
                                                   shape: IconButtonShape.CircleBorder16,
                                                   child: CommonImageView(
                                                     color: Colors.white,
                                                    svgPath: ImageConstant.imgGroup80,
                                                   ),
                                                 ),
                                                 Padding(
                                                   padding: EdgeInsets.only(
                            ...
                            Container(height: 1.00.h,
                                width: 335.00.w,
                                margin: EdgeInsets.only(left: 19.w, top: 16.h, right: 19.w),
                                decoration: BoxDecoration(color: ColorConstant
                                    .tealA7005f)),
                            Align(
                                alignment: Alignment.centerLeft, child: Padding(
                                padding: EdgeInsets.only(
                                    left: 20.w, top: 31.h, right: 20.w),
                            ...
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                ...
                                children: [
                                 Padding(padding: EdgeInsets.only(bottom: 4.h),
                                     child: Text("lbl_text_messages".tr,
                                         overflow: TextOverflow.ellipsis,
                                         textAlign: TextAlign.left,
                                         style: AppStyle.txtRubikLight16)),
                                 Obx(() =>
                                     CustomSwitch(margin: EdgeInsets.only(top: 1.h),
                                         value: controller.isSelectedSwitch
                                             .value,
                                         onChanged: (value) {
                            ...
                            Container(height: 1.00.h,
                                width: 335.00.w,
                                margin: EdgeInsets.only(left: 19.w, top: 14.h, right: 19.w),
                                decoration: BoxDecoration(color: ColorConstant
                                    .tealA70014)),
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                top: 14.h,
                                ...
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                 Padding(padding: EdgeInsets.only(top: 1.h, bottom: 2.h),
                                     child: Text("lbl_phone_calls".tr,
                                         overflow: TextOverflow.ellipsis,
                                         textAlign: TextAlign.left,
                                         style: AppStyle.txtRubikLight16)),
                                 Obx(() =>
                                     CustomSwitch(
                                         value: controller.isSelectedSwitch1
                            ...
                            Container(height: 1.00.h,
                                width: 335.00.w,
                                margin: EdgeInsets.only(left: 19.w, top: 18.h, right: 19.w),
                                decoration: BoxDecoration(color: ColorConstant
                                    .tealA70014)),
                            Padding(padding: EdgeInsets.only(left: 19.w,
                                top: 10.h,
